...
export const BREATHING_EXERCISES = {
  ...
  anti_stress: {
    ...
    cycles: Infinity,  
    description:'Паттерн: 4–2–6–2Медленный выдох длиннее вдоха.Описание:Ровное дыхание с удлинённым выдохом \
    помогает телу перейти из режима «напряжения» в режим «восстановления».Почему подходит при стрессе:Длинный выдох \
    активирует парасимпатическую нервную системуСнижается уровень кортизолаСердечный ритм стабилизируетсяВозникает \
    ощущение контроля и заземленияИдеально при рабочем напряжении, перегрузке, «перегорании».',   
    label: {
      inhale: 'Inhale',
      hold: 'Hold',
      exhale: 'Exhale',
  ...
  anti_depression: {
    ...
    holdAfterExhale: 4,
    cycles: Infinity,
    description:'Паттерн: 4–4–8–4Глубокий вдох + длительная задержка + очень длинный выдох.Описание:Глубокое, \
    осознанное дыхание с задержками способствует насыщению крови кислородом и телесному ощущению «присутствия».\
    Почему подходит при депрессии:Задержка после вдоха усиливает оксигенацию мозгаДлинный выдох снижает внутреннюю \
    зажатостьПомогает выйти из состояния апатии и «отключённости»Создаёт чувство глубины и устойчивостиПодходит \
    при упадке сил, апатии, эмоциональной пустоте.',
    label: {
      inhale: 'Inhale',
      hold: 'Hold',
      exhale: 'Exhale',
